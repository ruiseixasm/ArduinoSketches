...
protected:
    ...
    BroadcastSocket_EtherCard(JsonTalker** json_talkers, uint8_t talker_count)
...
public:
    ...
    static BroadcastSocket_EtherCard& instance(JsonTalker** json_talkers, uint8_t talker_count) {
