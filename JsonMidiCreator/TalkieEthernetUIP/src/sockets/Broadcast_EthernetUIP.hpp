...
*/
#ifndef BROADCAST_ETHERNET_UIP_HPP
#define BROADCAST_ETHERNET_UIP_HPP
...
class Broadcast_EthernetUIP : public BroadcastSocket {
protected:
    ...
    // Constructor
    Broadcast_EthernetUIP() : BroadcastSocket() {}
...
public:
    ...
    static Broadcast_EthernetUIP& instance() {
        static Broadcast_EthernetUIP instance;
        return instance;
    }

    const char* class_name() const override { return "Broadcast_EthernetUIP"; }


    void set_port(uint16_t port) { _port = port; }
    void set_udp(UIPUDP* udp) {
...
#endif // BROADCAST_ETHERNET_UIP_HPP
